...
function Home() {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        const res = await axios.get("http://16.170.254.172:4004/blog");
  ...
  const handleUpvote = async (id) => {
    ...
    try {
      await axios.put(`http://16.170.254.172:4004/blog/${id}`);
      const updatedBlogs = await axios.get("http://16.170.254.172:4004/blog");
  ...
  const handleReport = async (id) => {
    try {
      await axios.post(`http://16.170.254.172:4004/blog/${id}/report`, {
        reportedBy: username
      });
